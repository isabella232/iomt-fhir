...
// This simulated device application sends sample heart rate and blood pressure telemetry
// to an Azure IoT Hub.

// This application is based on the SimulatedDevice application at
// https://github.com/Azure-Samples/azure-iot-samples-csharp/tree/master/iot-hub/Quickstarts/SimulatedDevice,
// which uses the Azure IoT Hub device SDK for .NET.
...
namespace SimulatedDevice
{
    ...
    internal class Program
    {
        ...
        // How to obtain the connection string by using the Azure portal:
        //   Navigate to {Your IoT Hub resource} -> IoT devices -> {Your Device ID} -> Primary Connection String
        // How to obtain the connection string by using the Azure CLI:
        ...
        {
            Console.WriteLine("Simulated vital signs device.");
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct)
        {
            ...
            double minSystolic = 90;
            double minDiastolic = 60;
            var rand = new Random();

            while (!ct.IsCancellationRequested)
            {
                double currentHeartRate = minHeartRate + rand.NextDouble() * 50;
                double currentSystolic = minSystolic + rand.NextDouble() * 30;
                double currentDiastolic = minDiastolic + rand.NextDouble() * 20;
                ...
                message.Properties.Add("heartRateAlert", (currentHeartRate > 100) ? "true" : "false");
